<x-app-layout>
    ...
    <section class="container px-5 py-12 mx-auto">
        ...
        <div class="mb-12">
            <h2 class="text-2xl font-medium text-gray-900 title-font px-4">All jobs ({{ $listings_count->count() }})</h2>
        </div>
        <div class="-my-6">
            @foreach($listings as $listing)
                <a
                    href="{{ Route('listings.show', $listing->slug) }}"
                    class="py-6 px-4 flex flex-wrap md:flex-nowrap border-b border-gray-100 {{ $listing->is_highlighted ? 'bg-sky-500 text-white hover:bg-sky-200' : 'bg-white hover:bg-gray-100' }}"
                >
    ...
    <div class="px-20 display-4 pagination">
