<x-app-layout>
    ...
    <div class="container px-5">
        <h1 class="text-2xl font-medium text-gray-900 title-font font-bold">Related Posts</h1>
    </div>
    <div class="row ml-20 mr-20">
        @foreach ($related_posts as $post)
            <div class="col-md-4">
                <div class="card mb-4 box-shadow">
                    <img class="card-img-top" src="/storage/{{ $listing->logo }}" alt="Card image cap">
                    <div class="card-body">
                        <p class="card-text">
                            {{ Str::limit(strip_tags($post->content), 100, '...') }}</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <a href="{{ Route('listings.show',  $post->slug)
                                 }}"
