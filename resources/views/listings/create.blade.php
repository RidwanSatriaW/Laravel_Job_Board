    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="w-full md:w-1/2 py-24 mx-auto">
            ...
            >
                ...
                @endguest
                <div class="mb-4 mx-2">
                    <x-label for="title" value="Pekerjaan" />
                    <x-input
                        id="title"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="company" value="Perusahaan" />
                    <x-input
                        id="company"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="logo" value="Logo Perusahaan" />
                    <x-input
                        id="logo"
                        class="block mt-1 w-full"
                        type="file"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="location" value="Lokasi (e.g. Remote, United States)" />
                    <x-input
                        id="location"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="apply_link" value="Link Pendaftaran" />
                    <x-input
                        id="apply_link"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="tags" value="Tags (pisahkan dengan koma (,))" />
                    <x-input
                        id="tags"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="content" value="Deskripis" />
                    <textarea
                        id="content"
                        rows="8"
